class AnswerSheet < ActiveRecord::Base
  ...
  def rerecognize
    ...
    system("rm -Rf #{tmpdir}")
    system("mkdir #{tmpdir}")
    system("cp -R #{RAILS_ROOT}/faxocr_config/recognize_sheetreader #{tmpdir_sr}")
    ...
    system("ruby #{tmpdir}/result.rb #{RAILS_ROOT} #{MyAppConf::IMAGE_PATH_PREFIX} #{tmpdir}/echoresult.html")
  end
end
